...
static const char *TAG = "i2s_es8311_example";
...
void app_main(void)
{
    printf("ESP32-S2 I2S ES8311 Audio Controller Example\n");
    printf("============================================\n");
    ...
    audio_config.volume = CONFIG_EXAMPLE_VOICE_VOLUME;
    audio_config.microphone_enabled = false;
    ...
    ESP_LOGI(TAG, "Audio data size: %zu bytes", audio_data_size);

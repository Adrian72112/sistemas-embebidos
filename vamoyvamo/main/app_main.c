...
// Eliminada la definición duplicada. Mantenemos una única definición para el pin del LED.
...
// Renombrada de mqtt5_event_handler a mqtt_event_handler para mayor claridad
// ya que estás usando MQTT_PROTOCOL_V_3_1_1. Si en el futuro usas MQTTv5, podrías renombrarla de nuevo.
...
static void wifi_event_handler(void *arg, esp_event_base_t event_base,
    ...
    if (event_base == WIFI_EVENT && event_id == WIFI_EVENT_STA_START) {
        ...
        if (s_mqtt_client == NULL) {
            ...
            // Registramos el manejador de eventos con el nuevo nombre
...
static void wifi_init_sta(void) {
    ...
    wifi_config_t wifi_config = {
        .sta = {
            .ssid = "YOUR_WIFI_SSID",     // ¡IMPORTANTE! Reemplazar con tu SSID de WiFi
            .password = "YOUR_WIFI_PASS", // ¡IMPORTANTE! Reemplazar con tu contraseña de WiFi
            .threshold.authmode = WIFI_AUTH_WPA2_PSK,
            .sae_pwe_h2e = WIFI_SAE_MODE_PWE_BOTH,
        },
    };
